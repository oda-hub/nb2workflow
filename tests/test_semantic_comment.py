...
def test_semantic_comments():
    ...
    # assert normalize(r['extra_ttl']) == "@prefix oda: <http://odahub.io/ontology#> . @prefix xsd: <http://www.w3.org/2001/XMLSchema#> . oda:energyMin; oda:lower_limit 3; oda:upper_limit 30 ."
